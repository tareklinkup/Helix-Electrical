...
class Account extends CI_Controller {
    ...
    function getOtherIncomeExpense(){
        ...
        if(isset($data->dateFrom) && $data->dateFrom != '' && isset($data->dateTo) && $data->dateTo != ''){
            ...
            $materialDamageClause = " and md.damage_date between '$data->dateFrom' and '$data->dateTo'";
        ...
        $result = $this->db->query("
            ...
            (
                select ifnull(sum(mdd.damage_amount), 0) 
                from tbl_material_damage_details mdd
                join tbl_material_damage md on md.damage_id = mdd.damage_id
                where md.branch_id = '" . $this->session->userdata('BRANCHid') . "'
                and mdd.status = 'a'
                $materialDamageClause
            ) as material_damaged_amount,
...
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
    ...
    */
    public function loanTransactions() {
        ...
        $data['content'] = $this->load->view('Administrator/account/loan_transactions', $data, true);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function loanAccounts(){
        ...
        $data['content'] = $this->load->view('Administrator/account/loan_accounts', $data, true);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function loanView(){
        ...
        $data['content'] = $this->load->view('Administrator/account/loan_view', $data, true);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function loanTransactionReprot(){
        ...
        $data['content'] = $this->load->view("Administrator/account/loan_transaction_report", $data, true);
        $this->load->view("Administrator/index", $data);
    }
    ...
    public function loanLedger() {
        ...
        $data['content'] = $this->load->view("Administrator/account/loan_ledger", $data, true);
        $this->load->view("Administrator/index", $data);
    }
    ...
    */
    ...
    public function investmentAccount()  {
        ...
        $data['content'] = $this->load->view('Administrator/account/add_investment_account', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function investmentTransactions(){
        ...
        $data['content'] = $this->load->view('Administrator/account/investment_transactions', $data, true);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function investmentView(){
        ...
        $data['content'] = $this->load->view('Administrator/account/investment_view', $data, true);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function investmentTransactionReprot(){
        ...
        $data['content'] = $this->load->view("Administrator/account/investment_transaction_report", $data, true);
        $this->load->view("Administrator/index", $data);
    }
    ...
    public function investmentLedger() {
        ...
        $data['content'] = $this->load->view("Administrator/account/investment_ledger", $data, true);
        $this->load->view("Administrator/index", $data);
    }
    ...
    public function getCashLedger() {
        ...
        $ledger = $this->db->query("
            ...
            select 
                ...
                concat('Material Purchase - ', mp.invoice_no, ' - ', s.Supplier_Name, ' (', s.Supplier_Code, ')', ' - Bill: ', mp.total) as description,
                0.00 as in_amount,
                mp.paid as out_amount
            from tbl_material_purchase mp
            join tbl_supplier s on s.Supplier_SlNo = mp.supplier_id
            where mp.status = 'a'
            and mp.branch_id = '$this->brunch'
            and mp.purchase_date between '$data->fromDate' and '$data->toDate'
