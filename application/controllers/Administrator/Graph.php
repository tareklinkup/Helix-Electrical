<?php
    class Graph extends CI_Controller{
        ...
        public function getGraphData(){
            ...
            // Top Productions
            $topProductions = $this->db->query("
                select 
                    p.Product_Name as product_name,
                    ifnull(sum(pp.quantity), 0) as quantity
            ...
            $other_income_expense = $this->db->query("
                ...
                (
                    ...
                    where md.branch_id = '$this->branchId'
                    and mdd.status = 'a'
                    and month(md.damage_date) = '$month'
                    and year(md.damage_date) = '$year'
