                                ...
                                <form id="materialForm" v-on:submit.prevent="addToCart">
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-sm-8">
                                            <p style="color: red;text-align:center;">{{alert_message}}</p>
                                        </label>
                                        <div class="col-sm-4">
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            getProducts(){
                axios.post('/get_products', {isService: 'false'})
                    .then(res=>{
            ...
            addToCart(){
                ...
                if(this.selectedMaterial == null || this.selectedMaterial.material_id == ''){
                    this.alert_message = 'Please Select Material';
                    return;
                }
                ...
                if(ind > -1){
                    if((parseFloat(this.cart[ind].quantity) + parseFloat(this.selectedMaterial.quantity)) > parseFloat(this.stock_quantity)){
                        this.alert_message = 'Stock unavailable';
                        return;
                    }
            ...
            async removeFromProductCart(product){
                ...
                if(ind > -1){
                    if(this.cartProducts[ind].production_products_id) {
                        let stock = await axios.post('/get_product_stock', { productId: this.cartProducts[ind].product_id }).then(res => res.data);
            ...
            async saveProduction(){
                ...
                for (let index = 0; index < this.cart.length; index++) {
                    await axios.post('/get_material_stock', {material_id: this.cart[index].material_id})
                    .then( async res=>{
