...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-5"><img src="<?php echo base_url();?>uploads/company_profile_org/<?php echo $companyInfo->Company_Logo_org; ?>" alt="Logo" style="height:80px;width:auto" /></div>
