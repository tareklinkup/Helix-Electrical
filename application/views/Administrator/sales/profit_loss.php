			...
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Total (Product + Material) Damaged (-)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ parseFloat(otherIncomeExpense.damaged_amount) + parseFloat(otherIncomeExpense.material_damaged_amount) | decimal }}</td>
						</tr>
