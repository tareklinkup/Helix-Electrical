    ...
    template: `
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(quotation.SaleMaster_TotalSaleAmount) }}<br><br>
                    </div>
                </div>
            </div>
        </div>
        ...
        async print(){
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-5"><img src="/uploads/company_profile_org/${this.companyProfile.Company_Logo_thum}" alt="Logo" style="height:80px;width:auto" /></div>
